...
| pypi:mcp | 2.0.0 | **REVIEW_BEFORE_INSTALL** | 37 | low:ssrf; low:ssrf; low:ssrf |
...
| gh:modelcontextprotocol/python-sdk | ? | **REVIEW_BEFORE_INSTALL** | 37 | low:ssrf; low:ssrf; low:ssrf |

## Summary
- **9 SAFE_TO_INSTALL** · **11 REVIEW_BEFORE_INSTALL** · **0 DO_NOT_INSTALL**
